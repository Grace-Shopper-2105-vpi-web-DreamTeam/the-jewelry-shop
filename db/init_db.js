...
async function createInitialUsers() {
  ...
  try {
    const usersToCreate = [
      ...
      {emailAddress: "admin1234@gmail.com", username: 'admin12', password: 'admin1234', isAdmin: true},
...
async function testDB() {
  try {
    ...
    const cartWithUser = await addUserIdToCart(8, 7)
