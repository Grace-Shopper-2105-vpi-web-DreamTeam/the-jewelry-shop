...
async function createInitialProducts() {
  ...
  try {
    const productsToCreate = [
      {title: 'Rolex Submariner', description: 'black dial arabic numerals classic design', category: 'watches', price: '8252.97', inventory: '3', image: ""},
    ...
    const products = await Promise.all(productsToCreate.map(createProduct(products)));
