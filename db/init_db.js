...
async function createInitialProducts() {
  ...
  try {
    const productsToCreate = [
      ...
      {title: '"B" Necklace', description: 'Stylish stainless steel necklace with a "B" pendant', category: 'necklaces', price: '129.99', inventory: 352, image: "https://thejewelryshop.s3.us-east-2.amazonaws.com/bNecklace.png"},
